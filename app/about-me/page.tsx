        ...
        <div className="w-full h-auto px-10 py-3 md:px-36 sm:py-5 space-y-5">
            ...
            <div className="md:shadow hidden md:flex w-1/6 rounded-full">
                ...
                <Image
                    ...
                    width={180}
                    height={180}
                    className="border-4 border-orange-300 rounded-full"
                />
                </Link>
            </div>
            <div className="bg-white w-full md:w-5/6 rounded-md p-2">
                <h1 className="text-3xl md:text-5xl text-pretty font-extrabold orange-gradient ">
                    Software Developer
                </h1>
                <p className="text-gray-800 font-normal text-lg mt-2">
                    I&rsquo;m a backend-focused full-stack software developer driven
                    by a passion for solving problems through carefully crafted software 
                    systems.
                    
                    I prioritize writing clean, testable code and delivering 
                    high-quality results on time. I thrive in fast-paced environments,
                    adapt quickly, and excel at turning ideas into scalable products. 
                    With a strong background in building scalable backend systems, AI 
                    solutions, and automation workflows, I focus on creating technology 
                    that enhances efficiency and user experience.
                    
                    A continuous learner at heart, I&rsquo;m always seeking new knowledge
                    and ways to improve.
                ...
                <div className="flex gap-2 w-full p-2 shadow rounded-lg justify-between items-center mt-4">
                    ...
                    <Link key={label} href={href}target="_blank" className="flex items-center space-x-2">
                        ...
                        <p className="text-sm sm:text-md text-orange-600 hidden md:flex">{label}</p>
                    </Link>
                    ))}
                </div>
            </div>
            ...
            {/* Experience Section */}
            <section id="experience" className="rounded-3xl orange-gradient-bg w-full p-3">
            ...
            <div id="education" className="rounded-3xl orange-gradient-bg w-full p-3 ">
                ...
                <div className="">
                    ...
                    <div className="rounded-2xl bg-white w-full px-5 py-3 mb-3">
                        <div className="flex justify-between items-center">
                            ...
                            className="text-2xl font-medium text-gray-800 underline"
                            >
