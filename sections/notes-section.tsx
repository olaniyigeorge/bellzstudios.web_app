    ...
    return (
        ...
        <section className="w-full flex flex-col font-irishgrover justify-center items-center gap-3">
            <section className="w-full flex text-center justify-center items-center flex-col  gap-4">
                    <span className="text-xl text-center leading-loose w-full md:w-2/3  md:text-2xl text-black font-normal font-kanit ">
                    ...
                    <Link href="/notes" className="flex items-center bg-white bg-opacity-20 text-white mt-8 gap-2 hover:scale-[110%] hover:animate-swivvleH transition-all duration-800 ease-in-out shadow shadow-orange-500 p-3 md:p-4 dark:text-black  rounded-full">
                        <Image 
